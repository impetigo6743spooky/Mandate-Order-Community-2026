...
# 🎮 Mandate Order — Community Edition

**Grand strategy of governance, order, and political control.**
...
Mandate Order is a grand strategy game centered on political governance, institutional control, and provincial administration across a contested continent. Players draft decrees, manage rival factions, and enforce stability through turn-based decision-making. This Community Edition is a standalone build delivered as a self-contained package: no storefront or additional software required, with all content included.

For strategy players who want a self-contained, offline-ready edition of Mandate Order with all content included.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1733690/fd4ad02758aa5627f229d8dcb7514542c0813559/ss_fd4ad02758aa5627f229d8dcb7514542c0813559.1920x1080.jpg?t=1787648292" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1733690/5809014bc070fcad48b9644176a7fb77c853c832/ss_5809014bc070fcad48b9644176a7fb77c853c832.1920x1080.jpg?t=1787648292" alt="Screenshot 2" width="100%"></td>
...
- **Interface:** English, German, French, Spanish, Russian, Simplified Chinese
- **Voiceover:** English
...
- 🗳️ **Mandate System** — Issue mandates and decrees that reshape provinces turn by turn.
- 🏛️ **Institutional Management** — Balance courts, treasuries, and bureaus against faction pressure.
- 🗺️ **Provincial Campaign Map** — Govern dozens of provinces with unrest, loyalty, and supply layers.
- ⚖️ **Justice & Order** — Enforce laws, run trials, and suppress or negotiate with dissent.
- 🤝 **Diplomacy & Coalitions** — Negotiate treaties, alliances, and shared mandates with rival powers.
- 🌐 **LAN Multiplayer** — LAN and direct P2P connection supported for up to 8 players.
- 💾 **Offline Play** — Fully playable offline with no account or storefront required.
- 🧩 **Mod Support** — Load custom scenarios and rule mods from a local folder.
...
- Mandate Order: Crimson Accords
- Mandate Order: Frontier Provinces
- Mandate Order: Digital Governance Pack
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti / AMD Radeon RX 560, 2 GB VRAM | NVIDIA GeForce GTX 1060 / AMD Radeon RX 580, 6 GB VRAM |
| **Storage** | 20 GB available space | 20 GB available space (SSD) |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\MandateOrder\Saved`
